...
const CHARACTERS = [
  ...
  },
  {
    id: "spongebob",
    name: "SpongeBob",
    title: "The Imaginative Fry Cook",
    tagline: "Endlessly upbeat, weirdly durable, and one good idea from bending reality.",
    emoji: "🧽",
    color: "#f4e04d",
    colorDark: "#c9b520",
    stats: { hp: 90, atk: 60, def: 55, spd: 95, spc: 85 },
    moves: [
      {
        name: "Jellyfishing",
        category: "physical",
        power: 55,
        accuracy: 95,
        description: "Swings a net wildly. Careless, and the jellyfish sting back.",
        effect: { type: "dot", chance: 15, label: "Stung" },
      },
      {
        name: "Bubble Blast",
        category: "special",
      ...
      },
      {
        ...
        power: 100,
        accuracy: 70,
        description: "Bends the battle itself through sheer imagination. Huge power, huge risk.",
      },
    ],
  },
  {
    id: "fuggler",
    name: "Fuggler",
    title: "The Friendly Monster (Allegedly)",
    tagline: "Fuzzy, fanged, and deeply unsettling. Means well. Probably.",
    emoji: "🧸",
    color: "#8f6bd6",
    colorDark: "#5c3fa0",
    stats: { hp: 105, atk: 85, def: 70, spd: 55, spc: 60 },
    moves: [
      {
        name: "Bite",
        category: "physical",
        power: 70,
        accuracy: 95,
        description: "A surprisingly big mouth for such a small monster.",
      },
      {
        name: "Creepy Stare",
        category: "status",
        power: 0,
        accuracy: 100,
        description: "Fixes the opponent with an unblinking stare. Their Attack falters.",
      ...
      },
      {
        ...
        power: 0,
        accuracy: 100,
        description: "A horrifyingly loud, horrifyingly ugly cry. Breaks the opponent's guard.",
        effect: { type: "debuffTarget", stat: "def", stages: -1 },
      },
      {
        ...
        power: 60,
        accuracy: 90,
        description: "Smiles just a little too wide. Deeply off-putting, and a little painful.",
        effect: { type: "debuffTarget", stat: "atk", stages: -1, chance: 25 },
      },
    ],
  },
  {
